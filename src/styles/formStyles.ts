...
export const nafInput = '[font-family:var(--font-sans)] text-[13px] bg-[color:var(--surface)] border-[1.5px] border-[color:var(--rule)] rounded-[5px] py-2 px-[11px] text-[color:var(--ink)] transition-[border-color] duration-150 w-full focus:outline-none focus:border-[color:var(--accent)]';
export const nafTextarea = '[font-family:var(--font-sans)] text-[12.5px] bg-[color:var(--surface)] border-[1.5px] border-[color:var(--rule)] rounded-[5px] py-2 px-[11px] text-[color:var(--ink)] resize-y flex-1 leading-[1.55] transition-[border-color] duration-150 focus:outline-none focus:border-[color:var(--accent)]';
...
export const newAppBack = '[font-family:var(--font-mono)] text-[11px] text-[color:var(--ink-3)] no-underline hover:text-[color:var(--surface)]';
export const newAppTitle = 'text-[13px] font-semibold text-[color:var(--surface)]';
...
export const editAppCompany = 'text-[color:var(--accent-bg)] font-semibold';
